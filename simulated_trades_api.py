...
class BacktestRequest(BaseModel):
    ...
    reprocess_closed: bool = Field(False, description="Reprocess closed trades")
...
def run_backtest(
    ...
    Ensures every signal has a simulated trade:
    - Already closed trades: skipped
    - Open trades: check for exit triggers
    - No trade: create new simulation
    ...
    **Example:**
    ...
    try:
        ...
        result = service.run_backtest(
            ...
            reprocess_closed=request.reprocess_closed
        )
